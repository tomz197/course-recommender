...
def find_top_courses_multiple(idx_liked: List[str], idx_disliked: List[str], matrix: sp.csr_matrix, n: int) -> List[Tuple[int, float]]:
...
def recommend_courses_keywords(liked: List[str], disliked: List[str], courseClient: CourseClient, n: int) -> Tuple[List[CourseWithId]]:
