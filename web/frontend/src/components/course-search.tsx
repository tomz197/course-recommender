...
export function CourseSearch({
  ...
  const filteredCourses = courses.filter((course) => !excludeCourses.some((excluded) => excluded.id === course.id))
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-full p-0">
        <Command>
          ...
          <CommandList>
            <CommandEmpty>{isLoading ? "Searching..." : "No courses found."}</CommandEmpty>
            <CommandGroup>
